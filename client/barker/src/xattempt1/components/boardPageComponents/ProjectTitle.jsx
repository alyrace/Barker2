...
export default function ProjectTitle({ title = "", projectId }) {
  ...
  function updateProjectTitleHandler() {
    //ajax to add new card
    projectsActions.updateProjectTitle({ id: projectId, title: newProjectTitle });
    closeForm();
  }
  ...
  return (
    <ProjectTitleStyled>
      <div className="project-title-action">
        ...
        <div className="new-button-form">
          ...
          <div className="new-button-form--actions">
            <Button
              ...
              bg="var(--green)"
              color="#fff"
              onClick={updateProjectTitleHandler}
            >
              Save
            </Button>
