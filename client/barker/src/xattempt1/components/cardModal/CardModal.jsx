...
export default function CardModal({ cardId }) {
  ...
  function removeLabelHandler(id) {
    let newLabels = cardState.labels.filter((label) => label._id !== id);
  ...
  async function updateAjaxCall(props, cb) {
    try {
      ...
      if (res.data.success) {
        ...
        projectsActions.updateCardInProject({
          projectId: updatedCard.projectId._id,
        ...
        <div className="main-container">
          <div className="main">
            <CardTitle
              ...
              projectTitle={cardState.projectId.title}
