...
const CardModal = ({ cardId, open, setOpen, card, project }) => {
  ...
  return (
    <Modal open={open} onClose={() => setOpen(false)}>
      <div className={`${classes.paper} ${classes.cardModal}`}>
        ...
        <Checklist card={card} />
        <div className={classes.modalSection}>
          <MoveCard cardId={cardId} setOpen={setOpen} thisProject={project} />
          <div className={classes.modalBottomRight}>
            ...
            <DeleteCard cardId={cardId} setOpen={setOpen} project={project} />
          </div>
        </div>
      </div>
    </Modal>
